...
export const translations: Translations = {
  pl: {
    ...
    about: {
      ...
      text: "Specjalista IT z ponad 3-letnim doświadczeniem we wsparciu aplikacji krytycznych i administracji systemami. Łączę wiedzę zzakresu systemów Linux/Windows, baz danych oraz monitoringu zpraktyczną znajomością technologii kontenerowych i podejścia GitOps. Dążę do dalszego rozwoju w obszarze automatyzacjiprocesów IT oraz zaawansowanej administracji."
    },
    interests: {
